...
class Reproductor34 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reproductor34)
        ...
        val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.video_3_4)
