...
class Reproductor12 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reproductor12)
        ...
        val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.video_1_2)
