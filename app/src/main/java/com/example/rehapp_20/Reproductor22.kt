...
class Reproductor22 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reproductor22)
        ...
        val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.video_2_2)
