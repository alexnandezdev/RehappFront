...
class Reproductor31 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reproductor31)
        ...
        val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.video_3_1)
