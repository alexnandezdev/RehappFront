...
class Reproductor24 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_reproductor24)
        ...
        val videoUri = Uri.parse("android.resource://" + packageName + "/" + R.raw.video_2_4)
